...
int migrate_demote_mapping(struct page *page)
{
	...
	return migrate_mapping(page, next_nid, MR_DEMOTION);
}
...
{
	int next_nid = next_promotion_node(page_to_nid(page));

	return migrate_mapping(page, next_nid, MR_PROMOTION);
}
